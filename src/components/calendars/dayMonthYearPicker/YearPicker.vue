<template>
  <div class="year-picker" @mousedown="startDrag" @mousemove="onDrag" @mouseup="stopDrag" @mouseleave="stopDrag"
    @wheel="onScroll" @touchstart="startTouch" @touchmove="onTouchMove" @touchend="stopDrag">
    <div class="picker-wrapper">
      <div v-for="year in visibleYears" :key="year" :class="['picker-item', { selected: year === selectedYear }]"
